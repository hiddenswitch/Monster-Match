...
namespace WebGLKeyboard
{
    ...
    public class FixIndexFile : MonoBehaviour
    {
        ...
        public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject)
        {
            ...
            var text = File.ReadAllText(Path.Combine(pathToBuiltProject, "index.html"));
            const string original = "<div class=\"webgl-content\">";
            const string replace =
                "<script>\r\n\t\tfunction FixInputOnSubmit() {\r\n\t\t\tdocument.getElementById(\"fixInput\").blur();\r\n\t\t\tevent.preventDefault();\r\n\t\t}\r\n\t</script>\r\n    <div>\r\n\t\t<form onsubmit=\"FixInputOnSubmit()\" autocomplete=\"off\" style=\"width: 0px; height: 0px; position: absolute; top: -9999px;\">\r\n\t\t\t<input type=\"text\" id=\"fixInput\" oninput=\"gameInstance.Module.asmLibraryArg._FixInputUpdate(null)\" onblur=\"gameInstance.Module.asmLibraryArg._FixInputUpdate(null)\" style=\"font-size: 42px;\">\r\n\t\t</form>\r\n\t</div>\r\n\t<div class=\"webgl-content\">";

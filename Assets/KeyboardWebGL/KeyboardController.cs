...
namespace WebGLKeyboard
{
    ...
    public class KeyboardController : MonoBehaviour
    {
        ...
        private static
            ...
            extern
#endif
            void OpenInputKeyboard(string str)
#if !UNITY_EDITOR && UNITY_WEBGL
            ;
#else
        {
            Debug.Log(nameof(OpenInputKeyboard));
        }
        #endif
#if !UNITY_EDITOR && UNITY_WEBGL
        [DllImport("__Internal")]
...
#else
        {
            Debug.Log(nameof(CloseInputKeyboard));
        }
#endif
...
#else
        {
            Debug.Log(nameof(FixInputOnBlur));
        }
#endif
#if !UNITY_EDITOR && UNITY_WEBGL
        [DllImport("__Internal")]
...
#else
        {
            Debug.Log(nameof(FixInputUpdate));
        }
#endif

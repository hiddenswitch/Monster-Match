...
namespace Ink.Runtime
{
	...
	public class VariablesState : IEnumerable<string>
    {
        ...
        /// <summary>
        /// Indicates whether the story has this variable specified in it
        /// </summary>
        /// <param name="variableName"></param>
        /// <returns></returns>
        public bool ContainsDefaultGlobalVariable(string variableName)
        {
            return _defaultGlobalVariables.ContainsKey(variableName);
        }
